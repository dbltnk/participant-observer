...
window.GameConfig = {
    ...
    resources: {
        ...
        foodData: {
            ...
            'pine': { calories: 0, vitamins: [0, 0, 0, 0, 0], water: 0, fire: 2, emoji: '🌲' },
            'maple': { calories: 0, vitamins: [0, 0, 0, 0, 0], water: 0, fire: 2, emoji: '🍁' },
            'palm': { calories: 0, vitamins: [0, 0, 0, 0, 0], water: 0, fire: 1, emoji: '🌴' },
            'reed': { calories: 0, vitamins: [0, 0, 0, 0, 0], water: 0, fire: 1, emoji: '🪾' },
            'spruce': { calories: 0, vitamins: [0, 0, 0, 0, 0], water: 0, fire: 3, emoji: '🎄' },
            'bamboo': { calories: 0, vitamins: [0, 0, 0, 0, 0], water: 0, fire: 2, emoji: '🎋' },
            'leaf': { calories: 0, vitamins: [0, 0, 0, 0, 0], water: 0, fire: 1, emoji: '🍂' },
            'plant': { calories: 0, vitamins: [0, 0, 0, 0, 0], water: 0, fire: 1, emoji: '🪴' },
            'cactus': { calories: 0, vitamins: [0, 0, 0, 0, 0], water: 0, fire: 1, emoji: '🌵' },
            // Plants
            'apple': { calories: 30, vitamins: [20, 0, 20, 0, 0], water: 15, fire: 0, emoji: '🍎' },
            'banana': { calories: 25, vitamins: [0, 20, 0, 0, 0], water: 10, fire: 0, emoji: '🍌' },
            'orange': { calories: 28, vitamins: [0, 0, 30, 0, 0], water: 20, fire: 0, emoji: '🍊' },
            'grape': { calories: 22, vitamins: [0, 0, 0, 0, 20], water: 12, fire: 0, emoji: '🍇' },
            'strawberry': { calories: 20, vitamins: [20, 0, 0, 0, 0], water: 15, fire: 0, emoji: '🍓' },
            'pear': { calories: 26, vitamins: [0, 0, 20, 0, 0], water: 12, fire: 0, emoji: '🍐' },
            'peach': { calories: 24, vitamins: [20, 0, 0, 0, 0], water: 15, fire: 0, emoji: '🍑' },
            'plum': { calories: 23, vitamins: [0, 0, 20, 0, 0], water: 10, fire: 0, emoji: '🫐' },
            'cherry': { calories: 18, vitamins: [0, 0, 0, 0, 20], water: 12, fire: 0, emoji: '🍒' },
            'lemon': { calories: 15, vitamins: [0, 0, 30, 0, 0], water: 8, fire: 0, emoji: '🍋' },
            'pineapple': { calories: 32, vitamins: [0, 0, 25, 0, 0], water: 18, fire: 0, emoji: '🍍' },
            'mango': { calories: 30, vitamins: [20, 0, 0, 0, 0], water: 15, fire: 0, emoji: '🥭' },
            'coconut': { calories: 35, vitamins: [0, 0, 0, 0, 20], water: 5, fire: 0, emoji: '🥥' },
            'kiwi': { calories: 22, vitamins: [0, 0, 30, 0, 0], water: 12, fire: 0, emoji: '🥝' },
            'avocado': { calories: 40, vitamins: [0, 0, 0, 0, 25], water: 8, fire: 0, emoji: '🥑' },
            'shroom': { calories: 20, vitamins: [0, 20, 20, 0, 0], water: 5, fire: 0, emoji: '🍄‍🟫' },
            'mushroom': { calories: 20, vitamins: [0, 20, 20, 0, 0], water: 5, fire: 0, emoji: '🍄' },
            'rose': { calories: 5, vitamins: [0, 0, 0, 0, 10], water: 2, fire: 0, emoji: '🌹' },
            'tulip': { calories: 3, vitamins: [0, 0, 0, 0, 5], water: 1, fire: 0, emoji: '🌷' },
            'sunflower': { calories: 8, vitamins: [0, 0, 0, 0, 15], water: 3, fire: 0, emoji: '🌻' },
            'daisy': { calories: 2, vitamins: [0, 0, 0, 0, 3], water: 1, fire: 0, emoji: '🌼' },
            'lily': { calories: 4, vitamins: [0, 0, 0, 0, 8], water: 2, fire: 0, emoji: '🌸' },
            'lotus': { calories: 6, vitamins: [0, 0, 0, 0, 12], water: 4, fire: 0, emoji: '🪷' },
            'hibiscus': { calories: 3, vitamins: [0, 0, 0, 0, 6], water: 2, fire: 0, emoji: '🌺' },
            'carrot': { calories: 25, vitamins: [30, 0, 0, 0, 0], water: 8, fire: 0, emoji: '🥕' },
            'potato': { calories: 35, vitamins: [0, 0, 0, 0, 15], water: 5, fire: 0, emoji: '🥔' },
            'tomato': { calories: 22, vitamins: [0, 0, 25, 0, 0], water: 12, fire: 0, emoji: '🍅' },
            'onion': { calories: 15, vitamins: [0, 0, 0, 0, 10], water: 6, fire: 0, emoji: '🧅' },
            'garlic': { calories: 8, vitamins: [0, 0, 0, 0, 5], water: 2, fire: 0, emoji: '🧄' },
            'pepper': { calories: 20, vitamins: [0, 0, 30, 0, 0], water: 8, fire: 0, emoji: '🫑' },
            'cucumber': { calories: 16, vitamins: [0, 0, 0, 0, 8], water: 15, fire: 0, emoji: '🥒' },
            'lettuce': { calories: 12, vitamins: [0, 0, 0, 0, 10], water: 18, fire: 0, emoji: '🥬' },
            'broccoli': { calories: 20, vitamins: [0, 0, 0, 0, 15], water: 8, fire: 0, emoji: '🥦' },
            'cauliflower': { calories: 18, vitamins: [0, 0, 0, 0, 12], water: 6, fire: 0, emoji: '🥬' },
            'pumpkin': { calories: 28, vitamins: [0, 0, 0, 0, 15], water: 10, fire: 0, emoji: '🎃' },
            'eggplant': { calories: 20, vitamins: [0, 0, 0, 0, 10], water: 8, fire: 0, emoji: '🍆' },
            // Animals
            'rabbit': { calories: 35, vitamins: [0, 0, 20, 20, 0], water: 0, fire: 0, emoji: '🐰' },
            'deer': { calories: 40, vitamins: [0, 0, 20, 20, 0], water: 0, fire: 0, emoji: '🦌' },
            'squirrel': { calories: 30, vitamins: [0, 0, 0, 20, 20], water: 0, fire: 0, emoji: '🐿️' },
            'pheasant': { calories: 32, vitamins: [0, 0, 20, 20, 0], water: 0, fire: 0, emoji: '🦃' },
            'duck': { calories: 30, vitamins: [0, 0, 0, 20, 20], water: 0, fire: 0, emoji: '🦆' },
            'goose': { calories: 32, vitamins: [0, 0, 0, 20, 20], water: 0, fire: 0, emoji: '🦢' },
            ...
            'bear': { calories: 45, vitamins: [0, 0, 20, 20, 0], water: 0, fire: 0, emoji: '🐻' },
            'wolf': { calories: 42, vitamins: [0, 0, 20, 20, 0], water: 0, fire: 0, emoji: '🐺' },
            'lynx': { calories: 38, vitamins: [0, 0, 20, 20, 0], water: 0, fire: 0, emoji: '🐱' },
            'weasel': { calories: 28, vitamins: [0, 0, 20, 20, 0], water: 0, fire: 0, emoji: '🦡' },
            'raccoon': { calories: 30, vitamins: [0, 0, 0, 20, 20], water: 0, fire: 0, emoji: '🦝' },
            'skunk': { calories: 25, vitamins: [0, 0, 0, 20, 20], water: 0, fire: 0, emoji: '🦨' },
